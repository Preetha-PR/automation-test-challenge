...
public final class FrameworkLogger {
    ...
    private static final Consumer<String> TAKESCREENSHOT = (message)-> ExtentManager.getExtentTest().info("Test",
    ...
    public static void log(LogType status, String message) {
        if(!PropertyUtils.get(ConfigProperties.PASSEDSTEPSSCREENSHOTS).equalsIgnoreCase("yes")|| DataProviderUtils.getTESTTYPE().equalsIgnoreCase("API")) {
